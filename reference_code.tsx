import { CLOSE_ICON, MESSAGE_ICON } from "./src/assets";
...
class MessageWidget {
  ...
  constructor(position: string = "bottom-right") {
  ...
  async initialize() {
    ...
    dynamicBut.classList.add("bg-red-500");
    dynamicBut.innerHTML = "Open Modal";
    ...
    container.appendChild(dynamicBut);
  }
